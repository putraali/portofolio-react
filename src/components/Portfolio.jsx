    ...
    <section id="portfolio" className="portfolio-section">
      <div className="container">
        <div className="section-header">
          ...
          <p className="section-subtitle">A collection of my recent design and development projects</p>
        </div>
              ...
              <div className="portfolio-img-container">
                ...
                <div className="portfolio-overlay">
                  <div className="portfolio-links">
                    {item.demoUrl && (
                      <a href={item.demoUrl} target="_blank" rel="noopener noreferrer" className="portfolio-link">
                        <FiExternalLink />
                      </a>
                    )}
                    {item.githubUrl && (
                      <a href={item.githubUrl} target="_blank" rel="noopener noreferrer" className="portfolio-link">
                        <FiGithub />
                      </a>
                    )}
                    <button 
